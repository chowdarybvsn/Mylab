...
<head>
    ...
    <title>Bobba's DevOps Lab</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Bobba's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is Bobba's DevOps AWS Lab</p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; Bobba's devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
